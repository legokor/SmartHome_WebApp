...
namespace SmartHome_WebApp.Data.Repositories
{
    public class BuildingBlockRepository : IRepository<BuildingBlock>
    {
        ...
        public async Task<bool> Add(BuildingBlock newElement)
        {
            try
            {
        ...
        public async Task<List<BuildingBlock>> Find(Expression<Func<BuildingBlock, bool>> queryLambda)
        {
            try
            {
                using (var context = new ApplicationDbContext())
        ...
        public async Task<bool> Modify(BuildingBlock toModify)
        {
            try
            {
                using (var context = new ApplicationDbContext())
        ...
        public async Task<bool> Remove(BuildingBlock toDelete)
        {
            try
            {
                using (var context = new ApplicationDbContext())
